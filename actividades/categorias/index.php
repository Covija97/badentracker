...
<main>
    ...
    <a class="but align-left" href="new" with="50px" aling="left" title="Crear categoría">
    ...
    <input type="text" id="searchInput" placeholder="Buscar dentro de categorias..." class="search-input">
    ...
    <table class="table-main">
        ...
        <?php if ($query->num_rows > 0) {
            while ($row = $query->fetch_assoc()) {
                ...
                echo
                    "<td>
                        <a class=but  href='categoria?id=" . $row["cat_id"] . "'>" .
                ...
                ?>
                <td>
                    <a class="but align-left" href="categoria/delete.php?id=<?php echo $row["cat_id"];?> " title="Borrar categoria" onclick="return confirm('¿Estás seguro de que deseas borrar este categoria?');">
            ...
            echo "<tr><td colspan='7'>No hay categorias disponibles.</td></tr>";
        } ?>        
    </table>
</main>
<?php
