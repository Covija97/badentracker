...
<main>
    ...
    <input type="text" id="searchInput" placeholder="Buscar dentro de materiales..." class="search-input">
    ...
    <table class="table-main">
        ...
        <?php if ($query->num_rows > 0) {
            while ($row = $query->fetch_assoc()) {
                ...
                echo
                    "<td>
                        <a class=but  href='material?id=" . $row["mat_id"] . "'>" .
                ...
                ?>
                <td>
                    <a class="but align-left" href="material/delete.php?id=<?php echo $row["mat_id"];?> " title="Borrar material" onclick="return confirm('¿Estás seguro de que deseas borrar este material?');">
            ...
            echo "<tr><td colspan='7'>No hay materiales disponibles.</td></tr>";
        } ?>        
    </table>
</main>
<?php
