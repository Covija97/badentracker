...
<script>
    ...
    function addAct(num) {
        ...
        for (let i = 0; i < num; i++) {
            ...
            celdaComentario.innerHTML = `<textarea name="actividades[${i}][comentarios]" id="comentarios_${i}" placeholder="Comentarios sobre la actividad..." style="align:left;"></textarea>`;
        }
        $('.select2').select2();
